...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const signup = useCallback(async (email: string, password: string) => {
    ...
    // onAuthStateChanged handles creating the Firestore doc + setting user
  }, []);
  ...
  return (
    <AuthContext.Provider value={{ user, loading, login, signup, loginWithGoogle, logout, updateProfile, addAdmin }}>
      {children}
